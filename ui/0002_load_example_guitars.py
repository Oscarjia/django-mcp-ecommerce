...
def load_example_guitars(apps, schema_editor):
    ...
    example_guitars = [
        ...
        },
        {
            ...
            'short_description': 'A tech-inspired electric guitar featuring LED lights and binary code inlays that glow under stage lights.',
            'price': 649.00
        },
        {
            'name': 'Racing Guitar',
        ...
        },
        {
            ...
            'short_description': 'An ocean-themed guitar with a translucent blue-green finish, bubble-like pearl inlays, and ethereal tones with extended sustain.',
            'price': 499.00
        }
    ]
    
    for guitar in example_guitars:
        Product.objects.create(**guitar)

def reverse_load_example_guitars(apps, schema_editor):
    Product = apps.get_model('ui', 'Product')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(load_example_guitars, reverse_load_example_guitars),
    ] 